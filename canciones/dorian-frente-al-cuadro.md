...
- **Género:** Chamber pop, Synthwave
- **Tipo:** Canción
- **Año:** 2026
- **Fecha de composición:** 2026-05-30
- **Estado de publicación:** Sin procesar
- **Generador:** Claude + SUNO
- **Temas:** Obsesión, Belleza, Corrupción, Autodestrucción
- **Distribuidor:**
- **ISRC:**
- **Álbum:**
- **NotionPageID:** 30a22335-ada6-80cf-9d68-e1ef0f426e44
- **Música:**
...
- **Progresión:** Dm – B♭ – F – C / Am – G – B♭ – F
- **Estructura:** Intro → V1 → Pre-Coro → Coro 1 → V2 → Pre-Coro → Coro 2 → Puente → Coro 3 → Outro

## Armonía

- **Progresión base:** Dm – B♭ – F – C (verso) / Am – G – B♭ – F (coro)
- **Patrón rítmico:** Synthwave pulse (octave bass, gated snare, arpegiador)
- **Dinámica por sección:** Versos contenidos (pads + voz), pre-coros suben (entra batería), coros se abren (cuerdas + arpegiador), puente seco (spoke), coro 3 half-time pesado, outro se disuelve
- **Riff melódico:** Arpegiador de sintetizador en corcheas (Dm – B♭ – F – C) como motor rítmico constante

### Acordes por sección

| Sección | Acordes | Notas |
|---------|---------|-------|
| Intro | Dm – B♭ – F – C | Arpegiador solo, 8 compases |
| Verso 1 | Dm – B♭ – F – C | Pads synth, voz, sin batería |
| Pre-Coro | Am – G – B♭ – F | Entra bombo, tensión |
| Coro 1 | Am – G – B♭ – F / Am – G – B♭ – C | Batería completa, arpegios, cuerdas |
| Verso 2 | Dm – B♭ – F – C | Voz + pads, staccato cuerda |
| Pre-Coro 2 | Am – G – B♭ – F | Subida, sidechain más marcado |
| Coro 2 | Am – G – B♭ – F / Am – G – B♭ – C | Pleno, armonías vocales |
| Puente | F – E♭ – B♭ – F (spoken) | Seco, sin batería, tensión |
| Coro 3 | Am – G – B♭ – F (half-time) | Pesado, batería aplastada, voz desnuda |
| Outro | Dm – B♭add9 – Dm | Piano solo, arpegiador decayendo |

## Descripción

Chamber pop con motor de synthwave — arpegios impulsivos como el latido de una obsesión, cuerdas que se pudren con el protagonista. Para escuchar cuando entiendes que lo que más amas puede ser lo que te destruye desde dentro. Dorian Gray creyó que la belleza era inofensiva, que amar la forma no tenía consecuencia. Pero la belleza no ama: exige, ocupa, deja el cascarón vacío. La canción no narra el libro: habla desde dentro del que se descubre vaciado por su propia pasión. El cuadro no es una metáfora de la conciencia: es la factura. Cada deseo que no nació del corazón sino de la obsesión se cobra en el lienzo. La tesis es que cualquier pasión desbordada destruye, incluso una pasión por algo tan puro en apariencia como la belleza, porque el objeto del deseo termina siendo más real que el humano que lo sostiene. Si alguna vez has sacrificado algo importante por mantener una imagen, esta canción te mira sin piedad.

## Style Prompt

```
Spanish chamber pop with synthwave pulse, 105 BPM, arpeggiated synth sequence as rhythmic motor, string quartet and analog synth pads, grand piano, gated snare and driving drum machine, male baritone vocals moving from intimate verses to theatrical choruses, spoken word bridge with tense delivery, string swells and dissonant harmonics in climax, concert hall reverb, like M83 string arrangements meeting Antony and the Johnsons intimacy
```
...
Creíste que era por el placer
O por el ansia de tenerlo todo
No
Era por la belleza
Esa que parece que no pesa nada
Pero pesa más que la vida

(Vuelve el arpegiador, creciendo)
Y ahora miras al cuadro
Y entiendes de una vez
El monstruo no está en el óleo
El monstruo
Siempre fue usted
...
Clavas la hoja contra el lienzo
Y el grito no es del que está dentro
Eres tú
Siempre fuiste tú
...
| 12 | Cero verbos forzados | ✅ "La tela cobra" (cobrar deuda — válido), "el corazón no te miente" (coloquial real) |
| 13 | Cero negative parallelism | ✅ Puente: "Creíste que era por el placer / O por el ansia / No / Era por la belleza" — no estructura "No es X, es Y" |
| 14 | Sin parallel negation encadenada | ✅ Afirmación y negación alternadas en toda la letra |
| 15 | Sin anaphora abuse (máx 2 versos) | ✅ Máximo 1 verso con misma apertura (Cada deseo / Cada conquista / Cada caricia — dispersos, no contiguos) |
| 16 | Puente sin "Pero" al inicio | ✅ Puente empieza con "Creíste que era por el placer" |
| 17 | Título repetido <4 veces en chorus | ✅ 1 vez por coro (3 total) |
| 18 | Abstracto anclado a objeto concreto | ✅ belleza → hipoteca, lienzo, marco, hoja, óleo, espejo |
| 19 | Especificidad objetual | ✅ hoja (cuchilla), óleo, marco, espejo, arpegiador, cello |
| 20 | Sin promoción alcohol/tabaco/drogas | ✅ |
| 21 | Principios edificantes | ✅ Tesis: la obsesión desbordada destruye incluso si el objeto es la belleza — moraleja de templanza y autoexamen |
